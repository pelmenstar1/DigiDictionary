...
class AddEditExpressionMessageMapper(context: Context) :
    ...
    override fun mapToStringResource(type: AddEditRecordMessage) = when (type) {
        ...
        AddEditRecordMessage.EXISTING_EXPRESSION -> R.string.addExpression_existingExprError
        AddEditRecordMessage.DB_ERROR -> R.string.dbError
        AddEditRecordMessage.TOO_MANY_MEANING_LIST_ITEMS -> R.string.addExpression_tooManyMeaningListItemsError
