...
class ManageRemoteDictionaryProvidersFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
        ...
        with(binding) {
            ...
            viewLifecycleOwner.showSnackbarEventHandlerOnError(vm.deleteAction, container, R.string.manageRemoteDictProviders_deleteError)
            manageRemoteDictProvidersContainer.setupLoadStateFlow(viewLifecycleOwner, vm) {
